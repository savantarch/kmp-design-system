...
fun getProjectVersion(): String {
    if (project.hasProperty("version") && project.property("version").toString() != "1.0.0-SNAPSHOT") {
    ...
    return try {
        ...
        val latestTag = tags.lineSequence().firstOrNull { it.startsWith("v") }?.trim()
        latestTag?.removePrefix("v") ?: "1.0.0-SNAPSHOT"
    } catch (e: Throwable) {
        "1.0.0-SNAPSHOT"
    }
}
...
dokka {
    dokkaPublications.html {
        moduleVersion.set(getProjectVersion())
    }
}
